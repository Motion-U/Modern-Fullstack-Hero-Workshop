    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          status: 'A daily ibadah mobile tracker app for Muslims. Features include daily prayer tracker, daily quran recitation tracker and quran memorization, fasting tracker, dhikr tracker, and sadaqah tracker',
              ...
              <div
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                  <div class="w-full mt-4 text-normal text-sm text-left text-rose-200">
                    {{ item.tech }}
                  </div>
...
/* Using animation on the desired element */
.fade-zoom-in {
